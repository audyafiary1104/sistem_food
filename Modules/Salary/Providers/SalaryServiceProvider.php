...
class SalaryServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'salary'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/salary');
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'salary');
    }
    ...
    {
        $langPath = resource_path('lang/modules/salary');
